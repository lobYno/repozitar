...
--
-- Host: localhost
-- Generation Time: May 26, 2024 at 11:42 PM
...
(1, 'Lionel Messi', 36, '4', 'Inter Miami'),
(2, 'Cristiano Ronaldo', 39, '4', 'Al Nassr'),
(3, 'Kylian Mbappé', 25, '4', 'PSG'),
(4, 'Erling Haaland', 23, '4', 'Manchester City'),
(5, 'Kevin De Bruyne', 32, '3', 'Manchester City'),
(6, 'Alisson', 31, '1', 'Liverpool'),
(7, 'Jude Bellingham', 20, '3', 'Real Madrid'),
(8, 'Gavi', 19, '3', 'Barcelona'),
(9, 'Ronald Araujo', 25, '2', 'Barcelona'),
(10, 'Ángel Di Maria', 36, '4', 'Benfica');
